...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'bro ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬ *Broken Angle Private* ●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Asena.commands.map(
    ...
    Asena.addCommand({pattern: 'bro ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'● *Broken Angle PUBLIC* ●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Asena.commands.map(
            ...
            if (CMD_HELP === '') CMD_HELP += Lang.NOT_FOUND;
            await message.client.sendMessage(
                message.jid,'BrokenAngle PUBLIC\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
